...
void L_add11_12()
{
  ...
  //Int_t runNUM = 90854;
  // Int_t evtNUM = 10000;
TH1F *h12=new TH1F("h12","h12 with  +9.975e-10 FInal ",500,0.10e-6,0.15e-6);

 TString filename;
 for(int irun=100400;irun<100450;irun++)
   {

     if(irun != 100422 && irun!=100423 && irun!= 100441 && irun!=100442&& irun!=100446){
