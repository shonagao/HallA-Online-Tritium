...
// Looking for an event either that pass throught #2 or #1 or both that is aligning them together
...
void L_add2_1()
{
  ...
  //Int_t runNUM = 90854;
  // Int_t evtNUM = 10000;
TH1F *h1=new TH1F("h1"," +3.1976e-10 correct",500,0.10e-6,0.15e-6);
 TString filename;
 for(int irun=100400;irun<100580;irun++) //100380;irun<100585
   {
 if(irun!=100397 && irun!=100398 && irun!=100399 && irun!= 100422 && irun!=100423 && irun!=100441 && irun!=100442 && irun!= 100446 && irun !=100450 && irun!=100451 && irun!=100460 && irun!=100477 && irun!=100478 && irun!=100479 && irun!=100480 && irun!=100492 && irun!=100510 && irun!=100511 && irun!=100522 && irun!=100523 && irun!=100524 && irun!=100541 && irun!=100549 && irun!=100550 && irun!=100555 && irun!=100557 && irun!=100563 && irun!=100567 )
  ...
  Double_t RF_s2_mean;
  Double_t RF_s2_pad1_meanCorr;
  Double_t RF_s2_pad2_meanCorr;
...
RF_s2_pad1_meanCorr =(Ls2_tdchit[37] -Ls2_tdchit[47])*tdcTime  - (((Ls2_tdchit[30]- Ls2_tdchit[1])*tdcTime + (Ls2_tdchit[37] - Ls2_tdchit[49])*tdcTime )/2.0 + 9.5982e-09*L_trx[0]  -5.3783e-08*L_trth[0] - 1.592e-12*Ls2_ladc[1] +3.19760e-10); 


//RF_s2_pad1_meanCorr =(Ls2_tdchit[37] -Ls2_tdchit[47])*tdcTime  - (((Ls2_tdchit[30]- Ls2_tdchit[1])*tdcTime + (Ls2_tdchit[37] - Ls2_tdchit[49])*tdcTime )/2.0 + 9.82e-09*L_trx[0]  -4.9783e-08*L_trth[0] - 1.392e-12*Ls2_ladc[1] + 1.935e-9); 




// Do not change any variables
RF_s2_pad2_meanCorr = (Ls2_tdchit[37] -Ls2_tdchit[47])*tdcTime  - (((Ls2_tdchit[30] - Ls2_tdchit[2])*tdcTime + (Ls2_tdchit[37] - Ls2_tdchit[50])*tdcTime )/2.0 + 2.39686e-09*L_trx[0] - 3.32898e-08*L_trth[0] -1.24122e-12*Ls2_ladc[2] + 3.078e-9 );
 ...
 // Defining cuts
 if(LHRS_trig_bit2 && Ls2_pad[0]==1 && Ls2_nthit==1)
	   {
             RF_s2_mean = RF_s2_pad1_meanCorr;
	   }
	   else if( LHRS_trig_bit2 && Ls2_pad[0]==2 && Ls2_nthit==1 )
	     {
               RF_s2_mean = RF_s2_pad2_meanCorr;
	     }
	   else if( LHRS_trig_bit2 && (Ls2_pad[0]==1 && Ls2_pad[1]==2 ))

	     {
               RF_s2_mean = (RF_s2_pad1_meanCorr + RF_s2_pad2_meanCorr)/2.0;
         	}
