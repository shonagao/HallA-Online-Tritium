...
void L_add3_2()
{
  ...
  //Int_t runNUM = 90854;
  // Int_t evtNUM = 10000;
TH1F *h2=new TH1F("h2","h2 with  + 3.078e-9",500,0.10e-6,0.15e-6);
 TString filename;
...
RF_s2_pad3_meanCorr =(Ls2_tdchit[37] -Ls2_tdchit[47])*tdcTime  - (((Ls2_tdchit[30]- Ls2_tdchit[3])*tdcTime + (Ls2_tdchit[37] - Ls2_tdchit[51])*tdcTime )/2.0 + 5.50452e-09*L_trx[0]  -4.14532e-08*L_trth[0] - 1.18518e-12*Ls2_ladc[3] + 3.435e-9); 
 ...
 // Defining cuts
 if(LHRS_trig_bit2 && Ls2_pad[0]==2 && Ls2_nthit==1)
	   {
             RF_s2_mean = RF_s2_pad2_meanCorr;
	   }
	   else if( LHRS_trig_bit2 && Ls2_pad[0]==3 && Ls2_nthit==1 )
	     {
               RF_s2_mean = RF_s2_pad3_meanCorr;
	     }
	   else if( LHRS_trig_bit2 && (Ls2_pad[0]==2 && Ls2_pad[1]==3 ))
