...
void L_add9_10()
{
  ...
  //Int_t runNUM = 90854;
  // Int_t evtNUM = 10000;
TH1F *h10=new TH1F("h10","h10 with  -7.9345e-10e-10",500,0.10e-6,0.15e-6);
...
RF_s2_pad10_meanCorr = (Ls2_tdchit[37] -Ls2_tdchit[47])*tdcTime  - (((Ls2_tdchit[30] - Ls2_tdchit[10])*tdcTime + (Ls2_tdchit[37] - Ls2_tdchit[58])*tdcTime )/2.0 + 8.74297e-09*L_trx[0] -3.39145e-08*L_trth[0] -1.3259e-12*Ls2_ladc[10] -7.9345e-10);
 ...
 // Defining cuts
	   if(LHRS_trig_bit2 && Ls2_pad[0]==9 && Ls2_nthit==1)
	   {
             RF_s2_mean = RF_s2_pad9_meanCorr;
	   }
	   else if( LHRS_trig_bit2 && Ls2_pad[0]==10 && Ls2_nthit==1 )
	     {
                RF_s2_mean = RF_s2_pad10_meanCorr;
	     }
	   else if( LHRS_trig_bit2 && (Ls2_pad[0]==9 && Ls2_pad[1]==10 ))
