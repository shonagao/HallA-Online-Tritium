...
void RHRStime_2()
{
  gStyle->SetOptStat(1111);
   ...
   //  TH2F *h1 = new TH2F("h1", "",200,-1,1,500,0.31450e-6,0.3185e-6);
TH2F *h1 = new TH2F("h1", "",300,0.30e-6,0.35e-6,300,-1,1);
 TProfile *p1 = new  TProfile("p1","",200,-1,1,0.31e-6,0.325e-6);

  TString filename;
  for(int irun= 100500;irun<100501;irun++)
    {
  ...
  // Variable to be used event by event 
   ...
   // Define Tree leaf variable to hold the values
    ...
    // Set The Branch addres
	  ...
	  // { 2.52574e-9,3.01669e-9,4.48323e-9}
...
// #some calculation depending on TDC information and correction depending on i ([paddle which was hit)
	   h1->Fill(R_trx[0],RF_s2_mean);
	   // p1->Fill(R_trx[0],RF_s2_mean);
...
////////////////////////////////////////////////////////
  ...
  // p1 = h1->ProfileX("p1");
  // TProfile *p1 = new  TProfile("p1","",200,-1,1,0.31450e-6,0.3185e-6);
  // p1->Add(h1);
  TF1 *f1 = new TF1("f1","[0]+[1]*x",-0.4,0.2);
  p1->Fit("f1","R+");


  TCanvas *c1 = new TCanvas("c1", "c1",600,600);
  c1->cd();
  // p1->SetMaximum(0.325e-6);
  //  p1->SetMinimum(0.31e-6);
  h1->Draw();
  ...
  //TLine *l2 = new TLine(0.325e-6,-1,0.325e-6,1);
