// Author  and Bishnu
//06/21/2018/
// looking for an  event that either pass through pad#11 or pad# 12 or both
...
void coinTime11_12()
{
 ...
 TH1F *h11=new TH1F("h11","h11",500,0.55e-6,0.6e-6); 
...
RF_s2_pad12_meanCorr = (Rs2_tdchit[15] - Rs2_tdchit[14]) * tdcTime -(((Rs2_tdchit[15]-Rs2_tdchit[28])*tdcTime + (Rs2_tdchit[46]-Rs2_tdchit[60])*tdcTime)/2.0 + 5.42156e-9*R_trx[0]  - 3.68166e-08*R_trth[0] - 3.19282e-12*Rs2_lac[12] + 2.20e-9);
 ...
 //	h8->Fill(RF_s2_pad8_meanCorr);
	...
	//Defining cuts 
	if( HRS_trg_bit5 && Rs2_pad[0]==11 &&  Rs2_nthit==1)
	  {
	    RF_s2_mean = RF_s2_pad11_meanCorr;
	  }
	else if( HRS_trg_bit5 && Rs2_pad[0]==12 && Rs2_nthit==1 )
	  {
               RF_s2_mean = RF_s2_pad12_meanCorr;
	  }

	else if(  HRS_trg_bit5 &&((Rs2_pad[0]==11 && Rs2_pad[1]==12) /*||(Rs2_pad[0]==7 || Rs2_pad[0]==8)*/))
	{
