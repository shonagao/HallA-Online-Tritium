// Author  Bishnu
//06/11/2018/
// looking for an  event that either pass through pad#5 or pad# 6 or both
...
void coinTime6_5()
{
 ...
 TH1F *h5=new TH1F("h5","Either#5 fired or #6 or both;RF -s2 ;counts",500,0.55e-6,0.6e-6);
 TString filename;
...
RF_s2_pad5_meanCorr = (Rs2_tdchit[15] - Rs2_tdchit[14])*tdcTime -(((Rs2_tdchit[15]-Rs2_tdchit[21])*tdcTime + (Rs2_tdchit[46]-Rs2_tdchit[53])*tdcTime)/2.0 + 9.22121e-09 *R_trx[0] -3.04303e-08*R_trth[0] - 12.08217e-13*Rs2_lac[5] +2.0e-9); 
 ...
 //+  7.45e-11 looking for better number
			      ...
			      if(HRS_trig_bit5 && Rs2_pads[0]==5 && Rs2_nthit==1)
				{
				  RF_s2_mean =  RF_s2_pad5_meanCorr;
				}
			     else if( HRS_trig_bit5 && Rs2_pads[0]==6 && Rs2_nthit==1 )
				{
                                RF_s2_mean =  RF_s2_pad6_meanCorr;
				}
			     else if( HRS_trig_bit5 && Rs2_pads[0]==5 && Rs2_pads[1]==6 )
			       {

                                 RF_s2_mean =(RF_s2_pad5_meanCorr + RF_s2_pad6_meanCorr)/2.0;
