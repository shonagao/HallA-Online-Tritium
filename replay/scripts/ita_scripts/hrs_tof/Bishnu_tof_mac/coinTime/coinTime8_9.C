// Author  and Bishnu
//06/21/2018/
// looking for an  event that either pass through pad#8 or pad# 9 or both
...
void coinTime8_9()
{
 ...
 TH1F *h8=new TH1F("h8","h8",500,0.55e-6,0.6e-6); 
...
RF_s2_pad8_meanCorr = (Rs2_tdchit[15] - Rs2_tdchit[14]) * tdcTime -(((Rs2_tdchit[15]-Rs2_tdchit[24])*tdcTime + (Rs2_tdchit[46]-Rs2_tdchit[56])*tdcTime)/2.0 +0.787479e-08*R_trx[0]  - 3.18107e-08*R_trth[0]-5.95287e-13*Rs2_lac[8]);
       ...
       RF_s2_pad9_meanCorr = (Rs2_tdchit[15] - Rs2_tdchit[14]) * tdcTime -(((Rs2_tdchit[15]-Rs2_tdchit[25])*tdcTime + (Rs2_tdchit[46]-Rs2_tdchit[57])*tdcTime)/2.0 + 7.54862e-09*R_trx[0]  -3.5057e-08*R_trth[0] - 1.01789e-12*Rs2_lac[9] + 9.50e-10 ); 
 ...
 //	h8->Fill(RF_s2_pad8_meanCorr);
	...
	//Defining cuts 
	if( HRS_trg_bit5 && Rs2_pad[0]==8 &&  Rs2_nthit==1)
	  {
	    RF_s2_mean = RF_s2_pad8_meanCorr;
	  }
	else if( HRS_trg_bit5 && Rs2_pad[0]==9 && Rs2_nthit==1 )
	  {
               RF_s2_mean = RF_s2_pad9_meanCorr;
	  }

	else if(  HRS_trg_bit5 &&((Rs2_pad[0]==8 && Rs2_pad[1]==9) /*||(Rs2_pad[0]==7 || Rs2_pad[0]==8)*/))
	{
