...
// hsre I am using the coincidence evente by toshi
#include "TH1F.h"
#include "TCanvas.h"
#include "TString.h"
#include "TFile.h"
...
for(int irun = 111170;irun<11200;irun++)//100677;irun<100679
    {
      if(irun ==111193)continue;
      T->Add("/w/hallc-scifs17exp/hes-hks/gogami/HallA-Online-Tritium/replay/Rootfiles/nnL/coin/tri_coin_%d*.root",irun);
