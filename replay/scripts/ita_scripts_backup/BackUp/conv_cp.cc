...
if(target==1){
 ...
 tnew->Branch("NRp",&NRp,"NRp/I"); 
 tnew->Branch("NRpx",&NRpx,"NRpx/I");
 tnew->Branch("NRpy",&NRpy,"NRpy/I");
 tnew->Branch("NLp",&NLp,"NLp/I"); 
 tnew->Branch("NLpx",&NLpx,"NLpx/I");
 tnew->Branch("NLpy",&NLpy,"NLpy/I");
 // Path Lenght //
 ...
 tnew->Branch("NRtr_pathl",&NRtr_pathl,"NRtr_pathl/I"); 
 tnew->Branch("NRs2_pathl",&NRs2_pathl,"NRs2_pathl/I");
 tnew->Branch("NRs0_pathl",&NRs0_pathl,"NRs0_pathl/I");
 tnew->Branch("NLtr_pathl",&NLtr_pathl,"NLtr_pathl/I"); 
 tnew->Branch("NLs2_pathl",&NLs2_pathl,"NLs2_pathl/I");
 tnew->Branch("NLs0_pathl",&NLs0_pathl,"NLs0_pathl/I");
 // at Target angle //
 ...
 tnew->Branch("NRph",&NRph,"NRph/I"); 
 tnew->Branch("NRth",&NRth,"NRth/I");
 tnew->Branch("NLph",&NLph,"NLph/I"); 
 tnew->Branch("NLth",&NLth,"NLth/I");
 //================== HRS Right Arm ===============================//
 ...
 tnew->Branch("NRs0rt_c",&NRs0rt_c,"NRs0rt_c/I"); // Right arm s0 TDC              
 tnew->Branch("NRs0lt_c",&NRs0lt_c,"NRs0lt_c/I"); // Right arm s0 TDC              
 //---- Right arm S2 ----------// 
 ...
 tnew->Branch("NRs2rt_c",&NRs2rt_c,"NRs2rt_c/I"); // Right arm s2 TDC              
 tnew->Branch("NRs2lt_c",&NRs2lt_c,"NRs2lt_c/I"); // Right arm s2 TDC
 t1->SetBranchAddress("Ndata.RTDC.F1FirstHit",&NRF1);
 tnew->Branch("NRF1",&NLF1,"NRF1/I"); // Right arm F1tdc
 ...
 tnew->Branch("NLs0rt_c",&NLs0rt_c,"NLs0rt_c/I"); // Left arm s0 TDC              
 tnew->Branch("NLs0lt_c",&NLs0lt_c,"NLs0lt_c/I"); // Left arm s0 TDC
 //---- Left arm S2 ----------// 
 ...
 tnew->Branch("NLs2rt_C",&NLs2rt_c,"NLs2rt_c/I"); // Left arm s2 TDC              
 tnew->Branch("NLs2lt_c",&NLs2lt_c,"NLs2lt_c/I"); // Left arm s2 TDC 
 t1->SetBranchAddress("Ndata.LTDC.F1FirstHit",&NLF1);
 tnew->Branch("NLF1",&NLF1,"NLF1/I"); // Left arm F1tdc               
 ...
 tnew->Branch("NL_tr_beta",&NL_tr_beta,"NL_tr_beta/I"); // Left arm beta              
 ...
 ///======= particle information =================//
  // Beam //
  tnew->Branch("Beam_p",&Beam_p,"Beam_p/D"); // Electron beam momentom
  tnew->Branch("trig",&trig,"trig/D"); // Trigger conditon
  // beta //
  ...
  // momentum //
  tnew->Branch("Rp",Rp,"Rp[NRp]/D"); // Right arm momentom
  tnew->Branch("Rpx",Rpx,"Rpx[NRpx]/D"); // Right arm x-momentom 
  tnew->Branch("Rpy",Rpy,"Rpx[NRpy]/D"); // Right arm y-momentom 
  tnew->Branch("Lp",Lp,"Lp[NLp]/D"); // Left arm momentom
  tnew->Branch("Lpx",Lpx,"Lpx[NLpx]/D"); // Left arm x-momentom 
  tnew->Branch("Lpy",Lpy,"Lpx[NLpy]/D"); // Left arm y-momentom 

  // Path Length //
  tnew->Branch("Rtr_pathl",Rtr_pathl,"Rtr_pathl[NRtr_pathl]/D"); 
  tnew->Branch("Rs2_pathl",Rs2_pathl,"Rs2_pathl[NRs2_pathl]/D"); 
  tnew->Branch("Rs0_pathl",Rs0_pathl,"Rs0_pathl[NRs0_pathl]/D"); 
  tnew->Branch("Ltr_pathl",Ltr_pathl,"Ltr_pathl[NLtr_pathl]/D"); 
  tnew->Branch("Ls2_pathl",Ls2_pathl,"Ls2_pathl[NLs2_pathl]/D"); 
  tnew->Branch("Ls0_pathl",Ls0_pathl,"Ls0_pathl[NLs0_pathl]/D"); 
 // F1TDC //
  tnew->Branch("RF1",RF1,"RF1[NRF1]/D");                                       
  tnew->Branch("LF1",LF1,"LF1[NLF1]/D");  
  // at Target angle //
  tnew->Branch("Rth",Rth,"Rth[NRth]/D");  
  tnew->Branch("Rph",Rph,"Rph[NRph]/D");
  tnew->Branch("Lth",Lth,"Lth[NLth]/D");  
  tnew->Branch("Lph",Lph,"Lph[NLph]/D");
 // Right Arm A1 //                                                                   
...
tnew->Branch("Ra1npe",Ra1npe,"Ra1npe[NRa1ac]/D"); // Right arm AC1 NPE             
 ...
 // Right Arm S0 // 
  ...
  tnew->Branch("Rs0lt_c",Rs0lt_c,"Rs0lt_c[NRs0lt_c]/D"); // Right arm S0-Top(B) TDC
  tnew->Branch("Rs0rt_c",Rs0rt_c,"Rs0rt_c[NRs0rt_c]/D"); // Right arm S0-Bottom(A) TDC
  ...
  tnew->Branch("Rs2lt_c",Rs2lt_c,"Rs2lt_c[NRs2lt_c]/D"); // Right arm S2-Top(B) TDC
  tnew->Branch("Rs2rt_c",Rs2rt_c,"Rs2rt_c[NRs2rt_c]/D"); // Right arm S2-Bottom(A) TDC
  ...
  tnew->Branch("Ls0lt_c",Ls0lt_c,"Ls0lt_c[NLs0lt_c]/D"); // Left arm S0-Top(B) TDC
  tnew->Branch("Ls0rt_c",Ls0rt_c,"Ls0rt_c[NLs0rt_c]/D"); // Left arm S0-Bottom(A) TDC
  ...
  tnew->Branch("Ls2lt_c",Ls2lt_c,"Ls2lt_c[NLs2lt_c]/D"); // Left arm S2-Top(B) TDC
  tnew->Branch("Ls2rt_c",Ls2rt_c,"Ls2rt_c[NLs2rt_c]/D"); // Left arm S2-Bottom(A) TDC
