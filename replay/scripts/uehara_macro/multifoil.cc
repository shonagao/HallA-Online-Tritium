...
<<<<<<< HEAD
    ...
    peak_range_start[i][4]=-5.5;
    peak_range_start[i][5]=-3;
    peak_range_start[i][6]=-0.4;
    peak_range_start[i][7]=2;
    peak_range_start[i][8]=4.8;
    peak_range_start[i][9]=9.6;
    peak_range_start[i][10]=12;

    peak_range_end[i][0]=20;
    peak_range_end[i][1]=-11;
    peak_range_end[i][2]=-8.4;
    peak_range_end[i][3]=-6;
    peak_range_end[i][4]=-3.4;
    peak_range_end[i][5]=-0.8;
    peak_range_end[i][6]=1.5;
    peak_range_end[i][7]=4;
